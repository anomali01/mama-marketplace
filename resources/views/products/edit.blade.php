...
<body>
    ...
    <div class="container">
        ...
        <form action="{{ route('products.update', $product) }}" method="POST" enctype="multipart/form-data" class="form-card">
            ...
            <!-- Informasi Bagi Hasil (Fixed oleh sistem) -->
            <div style="background: #f0f9ff; border: 2px solid #0ea5e9; border-radius: 12px; padding: 20px; margin-bottom: 20px;">
                <div style="display: flex; align-items: center; gap: 10px; margin-bottom: 16px;">
                    ...
                    <h4 style="color: #0369a1; font-size: 16px; font-weight: 700; margin: 0;">💰 Informasi Bagi Hasil</h4>
                </div>
                
                <div style="background: white; border-radius: 10px; padding: 16px; margin-bottom: 12px;">
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                        <div style="text-align: center; padding: 12px; background: #fef3c7; border-radius: 8px;">
                            <div style="color: #92400e; font-size: 13px; font-weight: 500; margin-bottom: 6px;">Validator</div>
                            <div style="color: #b45309; font-size: 28px; font-weight: 700;">3%</div>
                        </div>
                        <div style="text-align: center; padding: 12px; background: #d1fae5; border-radius: 8px;">
                            <div style="color: #065f46; font-size: 13px; font-weight: 500; margin-bottom: 6px;">Anda (Penjual)</div>
                            <div style="color: #059669; font-size: 28px; font-weight: 700;">97%</div>
                        </div>
                    </div>
                </div>
                
                <div style="background: #fef3c7; border-left: 4px solid #fbbf24; padding: 12px; border-radius: 6px;">
                    <p style="margin: 0; font-size: 13px; color: #78716c; line-height: 1.6;">
                        <strong>📌 Catatan Penting:</strong> Sistem bagi hasil telah ditentukan oleh platform. 
                        Setiap produk yang terjual, Anda akan menerima <strong style="color: #059669;">97%</strong> dari harga jual, 
                        sementara <strong style="color: #b45309;">3%</strong> untuk validator sebagai biaya verifikasi produk.
                    </p>
                </div>
            </div>
