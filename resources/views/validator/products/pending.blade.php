...
<head>
    ...
    <title>Produk Menunggu Verifikasi - Validator MAMA</title>
...
<body>
    @include('validator.partials.sidebar', ['active' => 'pending'])

    <main class="main-content">
        <header class="header">
            <h1 class="header-title">Produk Menunggu Verifikasi</h1>
            ...
            <div class="section">
                        ...
                        <tbody>
                            @foreach($products as $product)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('validator.products.show', $product) }}" class="action-btn view" title="Review">
                                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                @else
                    <div class="empty-state">
                        ...
                        <h3>Semua Beres!</h3>
                        <p>Tidak ada produk yang menunggu verifikasi saat ini.</p>
                    </div>
                @endif
            </div>
        </div>
