...
<head>
    ...
    <title>Produk Terverifikasi - Validator MAMA</title>
...
<body>
    @include('validator.partials.sidebar', ['active' => 'verified'])

    <main class="main-content">
        <header class="header">
            <h1 class="header-title">Produk Terverifikasi</h1>
            ...
            <div class="section">
                ...
                @else
                    <div class="empty-state">
                        ...
                        <p>Belum ada produk yang terverifikasi.</p>
                    </div>
                @endif
            </div>
        </div>
